---
title: "Reid's Code - Crop Management Impacts the Soy (Glycine max) Microbiome"
author: "Moriah Young"
date: "2022-12-01"
output: pdf_document
---
...
# setwd("/Users/moriahyoung/Desktop/PLB 847/PLB 847 Group Project/Microbiome-Analysis-PLP847-main/")
...
ITS_metadata <-read.delim("root_fun_map_soybean_2021_1.txt",
                           row.names=1)
ITS_metadata
...
physeq_object_roots <- phyloseq(ITS_otus_phy,
                          ITS_metadata_phy,
                          ITS_taxonomy_phy,
                          ITS_sequences)
physeq_object_roots
tax_table(physeq_object_roots)
sample_data(physeq_object_roots)
```

```{r}
###formatting taxonomy------------------------
colnames(tax_table(physeq_object_roots)) = c(k = "Kingdom", p = "Phylum", c = "Class", o = "Order", f = "Family", g = "Genus", s = "Species")
#tax_table(physeq_object_roots)

tax_table(physeq_object_roots)[, "Kingdom"] <- gsub("d:", "", tax_table(physeq_object_roots)[, "Kingdom"])
tax_table(physeq_object_roots)[, "Phylum"] <- gsub("p:", "", tax_table(physeq_object_roots)[, "Phylum"])
tax_table(physeq_object_roots)[, "Class"] <- gsub("c:", "", tax_table(physeq_object_roots)[, "Class"])
tax_table(physeq_object_roots)[, "Order"] <- gsub("o:", "", tax_table(physeq_object_roots)[, "Order"])
tax_table(physeq_object_roots)[, "Family"] <- gsub("f:", "", tax_table(physeq_object_roots)[, "Family"])
tax_table(physeq_object_roots)[, "Genus"] <- gsub("g:", "", tax_table(physeq_object_roots)[, "Genus"])
tax_table(physeq_object_roots)[, "Species"] <- gsub("s:", "", tax_table(physeq_object_roots)[, "Species"])
#tax_table(physeq_object_roots)

#remove chloropast,mitochondria,cyanobacteria
physeq_object_roots <- subset_taxa(physeq_object_roots, Phylum!="Chloroplast")
physeq_object_roots <- subset_taxa(physeq_object_roots, Class!="Chloroplast")
physeq_object_roots <- subset_taxa(physeq_object_roots, Order!="Chloroplast")
physeq_object_roots <- subset_taxa(physeq_object_roots, Family!="Chloroplast")
physeq_object_roots <- subset_taxa(physeq_object_roots, Genus!="Chloroplast")
#tax_table(physeq_object_roots)

physeq_object_roots <- subset_taxa(physeq_object_roots, Phylum!="Mitochondria")
physeq_object_roots <- subset_taxa(physeq_object_roots, Class!="Mitochondria")
physeq_object_roots <- subset_taxa(physeq_object_roots, Order!="Mitochondria")
physeq_object_roots <- subset_taxa(physeq_object_roots, Family!="Mitochondria")
physeq_object_roots <- subset_taxa(physeq_object_roots, Genus!="Mitochondria")
#tax_table(physeq_object_roots)
...
sums_roots <- data.frame(colSums(otu_table(ps.noncontam_roots)))
colnames(sums_roots) <- "Sample_totalSeqs_roots"
sums_roots$Sample <- row.names(sums_roots)

ggplot(sums_roots, aes(x=Sample_totalSeqs_roots)) +
...
# Moriah - code below doesn't work for me and idk why
...
x <- kruskal.test(Observed ~ Indicator_label, data = alpha_div_soil_fungi_df_V2)
pairwise.wilcox.test(alpha_div_soil_fungi_df_V2$Observed, alpha_div_soil_fungi_df_V2$Indicator_label,
                     p.adjust.method = "fdr")
...
kruskal.test(Observed ~ Indicator_label, data = alpha_div_roots_fungi_df_V2)
pairwise.wilcox.test(alpha_div_roots_fungi_df_V2$Observed, alpha_div_roots_fungi_df_V2$Indicator_label,
                     p.adjust.method = "fdr")
#roots R2 rich
...
kruskal.test(Observed ~ Indicator_label, data = alpha_div_roots_fungi_df_R2)
pairwise.wilcox.test(alpha_div_roots_fungi_df_R2$Observed, alpha_div_roots_fungi_df_R2$Indicator_label,
                     p.adjust.method = "fdr")
...
kruskal.test(Observed ~ Indicator_label, data = alpha_div_roots_fungi_df_R6)
pairwise.wilcox.test(alpha_div_roots_fungi_df_R6$Observed, alpha_div_roots_fungi_df_R6$Indicator_label,
                     p.adjust.method = "fdr")
...
kruskal.test(Shannon ~ Indicator_label, data = alpha_div_roots_fungi_df_V2)
pairwise.wilcox.test(alpha_div_roots_fungi_df_V2$Shannon, alpha_div_roots_fungi_df_V2$Indicator_label,
                     p.adjust.method = "fdr")
#roots R2 shan
...
kruskal.test(Shannon ~ Indicator_label, data = alpha_div_roots_fungi_df_R2)
pairwise.wilcox.test(alpha_div_roots_fungi_df_R2$Shannon, alpha_div_roots_fungi_df_R2$Indicator_label,
                     p.adjust.method = "fdr")
# roots R6 shan
...
kruskal.test(Shannon ~ Indicator_label, data = alpha_div_roots_fungi_df_R6)
pairwise.wilcox.test(alpha_div_roots_fungi_df_R6$Shannon, alpha_div_roots_fungi_df_R6$Indicator_label,
                     p.adjust.method = "fdr")
#roots V2 even
...
kruskal.test(Jevenness ~ Indicator_label, data = alpha_div_roots_fungi_df_V2)
pairwise.wilcox.test(alpha_div_roots_fungi_df_V2$Jevenness, alpha_div_roots_fungi_df_V2$Indicator_label,
                     p.adjust.method = "fdr")
#roots R2 even
...
kruskal.test(Jevenness ~ Indicator_label, data = alpha_div_roots_fungi_df_R2)
pairwise.wilcox.test(alpha_div_roots_fungi_df_R2$Jevenness, alpha_div_roots_fungi_df_R2$Indicator_label,
                     p.adjust.method = "fdr")
# roots R6 even
...
kruskal.test(Jevenness ~ Indicator_label, data = alpha_div_roots_fungi_df_R6)
pairwise.wilcox.test(alpha_div_roots_fungi_df_R6$Jevenness, alpha_div_roots_fungi_df_R6$Indicator_label,
                     p.adjust.method = "fdr")
...
kruskal.test(Observed ~ Indicator_label, data = alpha_div_roots_fungi_df_Conventional)
pairwise.wilcox.test(alpha_div_roots_fungi_df_Conventional$Observed, alpha_div_roots_fungi_df_Conventional$Indicator_label,
                     p.adjust.method = "fdr")
#roots No-Till rich
...
kruskal.test(Observed~ Indicator_label, data = alpha_div_roots_fungi_df_No_Till)
pairwise.wilcox.test(alpha_div_roots_fungi_df_No_Till$Observed, alpha_div_roots_fungi_df_No_Till$Indicator_label,
                     p.adjust.method = "fdr")
# roots Organic rich
alpha_div_roots_fungi_df_Organic
...
kruskal.test(Observed ~ Indicator_label, data = alpha_div_roots_fungi_df_Organic)
pairwise.wilcox.test(alpha_div_roots_fungi_df_Organic$Observed, alpha_div_roots_fungi_df_Organic$Indicator_label,
                     p.adjust.method = "fdr")
...
kruskal.test(Shannon ~ Indicator_label, data = alpha_div_roots_fungi_df_Conventional)
pairwise.wilcox.test(alpha_div_roots_fungi_df_Conventional$Shannon, alpha_div_roots_fungi_df_Conventional$Indicator_label,
                     p.adjust.method = "fdr")
#roots No-Till shan
...
kruskal.test(Shannon ~ Indicator_label, data = alpha_div_roots_fungi_df_No_Till)
pairwise.wilcox.test(alpha_div_roots_fungi_df_No_Till$Shannon, alpha_div_roots_fungi_df_No_Till$Indicator_label,
                     p.adjust.method = "fdr")
...
kruskal.test(Shannon ~ Indicator_label, data = alpha_div_roots_fungi_df_Organic)
pairwise.wilcox.test(alpha_div_roots_fungi_df_Organic$Shannon, alpha_div_roots_fungi_df_Organic$Indicator_label,
                     p.adjust.method = "fdr")
...
kruskal.test(Jevenness ~ Indicator_label, data = alpha_div_roots_fungi_df_Conventional)
pairwise.wilcox.test(alpha_div_roots_fungi_df_Conventional$Jevenness, alpha_div_roots_fungi_df_Conventional$Indicator_label,
                     p.adjust.method = "fdr")
#roots No-Till even
...
kruskal.test(Jevenness ~ Indicator_label, data = alpha_div_roots_fungi_df_No_Till)
pairwise.wilcox.test(alpha_div_roots_fungi_df_No_Till$Jevenness, alpha_div_roots_fungi_df_No_Till$Indicator_label,
                     p.adjust.method = "fdr")
# roots Organic even
alpha_div_roots_fungi_df_Organic
...
kruskal.test(Jevenness ~ Indicator_label, data = alpha_div_roots_fungi_df_Organic)
pairwise.wilcox.test(alpha_div_roots_fungi_df_Organic$Jevenness, alpha_div_roots_fungi_df_Organic$Indicator_label,
                     p.adjust.method = "fdr")
...
otu_table(ps.noncontam_roots)[otu_table(ps.noncontam_roots) <= 4] <- 0
ps.noncontam_roots
sample_data(ps.noncontam_roots)

# removes any OTUs that has less than 10 total reads across all samples
otu_table(ps.noncontam_roots) <- otu_table(ps.noncontam_roots)[which(rowSums(otu_table(ps.noncontam_roots)) >= 10),]
sample_data(ps.noncontam_roots)

#check for additional samples soil 1000
write.csv(otu_table(ps.noncontam_roots), file = "roots_check.csv")

# remove additional samples that went soil 1000 reads following this processesing ???? - moriah
#otu_table(ps.noncontam_roots) <- subset(otu_table(ps.noncontam_roots),
#                                             select = -c(T4R2BV2R, T1R2AV2R))

write.csv(otu_table(ps.noncontam_roots), file = "depth_check_root.csv")
...
#roots
root_barplots <- merge_samples(ps.noncontam_roots, "bar_label")
#rownames(root_barplots) <- root_barplots$OTU # Moriah added this and it didn't work
...
write.csv(sample_data(root_barplots), file ="sample_data_root_bp.csv")
